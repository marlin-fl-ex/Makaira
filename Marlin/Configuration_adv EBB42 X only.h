...
#define HOMING_BUMP_MM      { 5 }       // (linear=mm, rotational=°) Backoff from endstops after first bump
...
//  #define MANUAL_FEEDRATE { 50*60, 50*60, 2*60 } // (mm/min) Feedrates for manual moves along X, [Y[, Z]], E from panel
  #define MANUAL_FEEDRATE { 50*60, 2*60 } // (mm/min) Feedrates for manual moves along X, [Y[, Z]], E from panel
...
// The value of BLOCK_BUFFER_SIZE must be a power of 2 (e.g., 8, 16, 32)
  ...
  #define BLOCK_BUFFER_SIZE 4 //TEST improve response time to changes
#else
  #define BLOCK_BUFFER_SIZE 8 //TEST improve response time to changes
#endif
